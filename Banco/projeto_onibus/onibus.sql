...
LOAD DATA INFILE 'D:/banco de dados/a/projeto_onibus/motorista.csv'
...
LOAD DATA INFILE 'D:/banco de dados/a/projeto_onibus/telefone.csv'
INTO TABLE telefone
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/banco de dados/a/projeto_onibus/linha.csv'
INTO TABLE linha
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/banco de dados/a/projeto_onibus/horario.csv'
INTO TABLE horario
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/banco de dados/a/projeto_onibus/dirige.csv'
INTO TABLE dirige
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
